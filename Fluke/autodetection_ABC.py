# -*- encoding: utf-8 -*-
"""
@File    : autodetection_ABC.py
@Time    : 2020-7-28 上午 9:01
@Author  : major
...
records9 = (('A相功率因数', df['Power Factor AN Avg'].max(), df['Power Factor AN Avg'].min(), df['Power Factor AN Avg'].mean(),
            np.percentile(df['Power Factor AN Avg'], 95, axis=0)),
            ('B相功率因数', df['Power Factor BN Avg'].max(), df['Power Factor BN Avg'].min(), df['Power Factor BN Avg'].mean(),
            np.percentile(df['Power Factor BN Avg'], 95, axis=0)),
            ('C相功率因数', df['Power Factor CN Avg'].max(), df['Power Factor CN Avg'].min(), df['Power Factor CN Avg'].mean(),
            np.percentile(df['Power Factor CN Avg'], 95, axis=0)),
