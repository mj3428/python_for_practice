...
with open('F:/text classification/stop/stopword.txt', 'rb') as f:
...
train_documents, train_labels = load_data('F:/text classification/train')
test_documents, test_labels = load_data('F:/text classification/test')
